...
2) Visualize the spatial data of urban expansion, to make it more understandable for wide public and decision makers.
...
1. Download the whole data from their official websites as follows, and classify the data and then extract the final maps of urban expansion.
...
2. Work on my data in GOOGLE EARTH ENGINE using code editor and extract just the final maps of urban expansion
